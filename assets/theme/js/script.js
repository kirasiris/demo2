    ...
    $(function(){
        ...
        if ($.fn.jarallax && !$.isMobile()) {
            ...
            $(window).on('update.parallax', function(event) {
                var $jarallax = $('.bp-parallax-background');
                ...
                for (var i = 0; i < patterns.length; i++){
                    if (result = patterns[i].exec(videoURL)){
                        ...
                        if ($.fn.YTPlayer && !$.isMobile()){
                            ...
                            $('> *:eq(1)', this).before('<div class="bp-background-video"></div>').prev()
                                .YTPlayer($.extend({
                                    videoURL : result[1],
                                    containment : 'self',
                                    showControls : false,
        ...
        $('.cols-same-height .bp-figure').each(function() {
            var $imageCont = $(this)
        ...
        $(document).ready(function() {
            ...
            if ($.isMobile()) {
              ...
              //enable animation on scroll
                ...
                var $animatedElements = $('p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .bp-author-name, em, label, input, textarea, .input-group, .iconbox, .btn-social, .bp-figure, .bp-map, .bp-testimonial .card-block, .bp-price-value, .bp-price-figure, .dataTable, .dataTables_info').not(function() {
                    return $(this).parents().is('.navbar, .bp-arrow, footer, .iconbox, .bp-slider, .bp-gallery, .bp-testimonial .card-block, #cookiesdirective, .bp-wowslider, .accordion, .tab-content, .engine, .extFooter1, #scrollToTop');
